...
\textbf{organização©}\quad			 		 {Erik Petschelies e Peter Schröder}\\
\textbf{tradução do alemão©}\quad			 {Erik Petschelies}\\
%\textbf{posfácio©}\quad			 		 	 {Fábio Zuker}\\
%\textbf{ilustração©}\quad			 		 {copyrightilustracao}\medskip

\textbf{título original}\quad			 	 {\textit{Die Aruaken} (1917)}\\
