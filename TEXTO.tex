...
\hedramarkboth{Nota do tradutor}{}
...
\part[os aruaques]{\textsc{os aruaques\\uma contribuição\\ para o problema da difusão cultural}}
...
\textls[-10]{Justamente no presente trabalho sobre a expansão das culturas Aruaque na
...
apreciação de Arthur Haberland.\footnote{\textls[-10]{Arthur Haberland,
...
\textls[-10]{Uma vez que o alcance deste trabalho se estende para além do âmbito dos
...
sobre placas achatadas de argila,\footnote{Max Schmidt,
  \emph{Indianerstudien in Zentralbrasilien}, p. 107.} em panquecas\footnote[*]{Beijus. {[}Nota do tradutor{]}}
...
\textls[-5]{No rapto de mulheres, nos deparamos com uma forma típica de matrimônio
...
Aweti.\footnote{\textls[-25]{Do mesmo autor, \emph{Unter den Naturvölkern
...
\textls[-8]{Naturalmente as relações entre parentes de diferentes tribos são
...
\textls[-15]{Os casamentos entre indivíduos de tribos diferentes também desempenham
...
\textls[-10]{Outra oportunidade para as frequentes visitas são as grandes festas,
...
\textls[-5]{Apenas após um convívio mais íntimo com os índios pode"-se auferir um
...
\textls[-10]{O papel mais importante no ciclo de ideias dos Paresí"-Kabizi é
...
\textls[-31]{O bom médico ou feiticeiro, o \emph{otuhariti}, é o único capaz de agir
...
panquecas de farinha prontas para o consumo,\footnote[*]{Beijus. {[}Nota do tradutor{]}} uma
...
\emph{Kugelbogen}; em inglês, \emph{pellet bow}. {[}Nota do tradutor{]}} limitado a
...
\chapter[Caminhos próprios: As pesquisas de Max Schmidt no contexto da antropologia contemporânea de língua alemã, \emph{por Michael Kraus}]{Caminhos próprios \subtitulo{As pesquisas de Max Schmidt no contexto da antropologia contemporânea de língua alemã\footnote[*]{\textls[-20]{Tradução do
...
\begin{flushright}
\textsc{michael kraus}\medskip
\end{flushright}

\begin{quote}
\textls[-10]{Na edificação da Etnologia Brasileira, colocando pedra sobre pedra, Max
...
\section{Contextualização I\break expedições e lobos solitários}
...
\textls[-5]{Mais tarde, Max Schmidt, que chegou a Cuiabá, capital de Mato Grosso,
...
\section{Contextualização II\break os debates contemporâneos~na~etnologia~alemã}
...
\section{Contextualização III\break correntes contemporâneas na investigação\break
...
\begin{itemize}
\item[]\textls[-30]{StA Lu Staatsarchiv Ludwigsburg {[}Arquivos de Estado de Ludwigsburg{]}}

\item[]\textls[-25]{\textsc{vk} Mr Nachlass Theodor Koch"-Grünberg. Völkerkundliche Sammlung der
...
\textls[-20]{Max Schmidt nasceu em Altona,\footnote{Bairro da cidade de Hamburgo.} a
...
\begin{flushright}
\textsc{paulo de carvalho neto (1923--2003)}\medskip
\end{flushright}
