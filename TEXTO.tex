...
\textsc{bdcn}\footnote{\textless{}http://www.etnolinguistica.org/biblio:schmidt-1917-aruaques\textgreater{};
...
do Sul no início do século \textsc{xx}: ``Com nomes como Caraibas, Aruaque, Tupi,
...
sul"-americanas\footnote{Ehrenreich, „Die Ethnographie Südamerikas im
  Beginn des \textsc{xx}. Jahr­hunderts'', p. 42.}, enquanto se trata de uma
...
aceita pela etnologia moderna\footnote{Cf., por exemplo, Ehrenreich,
  ...
  Chaco até o fim do século \textsc{xviii}{]}, in: \emph{Inter­nationales Archiv
...
culturais\footnote{K. von den Steinen, \emph{Unter den Naturvölkern
  ...
  unter den Indianern}, l. c., v.\,\textsc{ii}, p. 231.}, no entanto as condi­ções
...
flutuantes\footnote{Ehrenreich, ``Beiträge zur Völkerkunde Brasiliens'',
  ...
  autor: „Die Ethnographie Südamerikas im Be­ginn des \textsc{xx}.
...
distintos\footnote{Ehrenreich, „Die Ethnographie Südamerikas im Beginn
  des \textsc{xx}. Jahrhun­derts'', l. c., p. 48.}.
...
Jamamadi e Paumari, visitados por Ehrenreich\footnote{Cf. Ehrenreich,
  „Die Ethnographie Südamerikas im Beginn des \textsc{xx}. Jahr­hunderts'', p.
  49.}.
...
da língua Be­toya\footnote{Op. cit., v.\,\textsc{ii}, p. 66 e 137.}. Como se pode
...
Negro para baixo muitíssimo para Leste\footnote{Martius, \emph{Beiträge
  zur Ethnographie und Sprachkunde Amerikas, zumal Brasi­liens}, v.\,\textsc{i},
...
os nativos\footnote[*]{O termo em alemão, nesse caso, é \emph{Naturvölker}, literalmente
  ...
  pela etnologia moderna de língua alemã {[}Nota do tradutor{]}.} sul"-americanos estão afeiçoados às suas mulheres e aos seus
...
entre os Aruaque de destinar a noiva ainda criança a um jovem\footnote{Em
  ...
  Rechtswissen­schaft}, v.\,\textsc{xiii} (1899), p. 309.}. Assim, entre os
...
mantinham, de acordo com Martius\footnote{Martius, \emph{Beiträge zur
  Ethnographie und Sprachkunde Amerikas, zumal Brasi­liens}, v.\,\textsc{i}, p.
...
frequentemente das cerimônias funerárias\footnote{Koch"-Grünberg,
  \emph{Zwei Jahre unter den Indianern}, v.\,\textsc{i}, p. 169ss; v.\,\textsc{ii}, p. 138 ss.}.
...
Koch"-Grünberg\footnote{Koch"-Grünberg, \emph{Zwei Jahre unter den
  Indianern}, p. ex., v.\,\textsc{i}, p. 169 ss.} nos fornece, no relato de sua
...
satisfação de suas necessidades, tanto mais as pulsões\footnote[*]{O termo em alemão é \emph{Trieb}. Sabidamente há diversos debates
  ...
  conceitual com Freud {[}Nota do tradutor{]}.} humanas também
...
camaradas\footnote[*]{Em português no original {[}Nota do tradutor{]}.}, com a qual entre os brasileiros se com­preende os
...
Sul{]}\footnote{Na \emph{Zeitschrift für vergleichende
  Rechtswissenschaft}, v.\,\textsc{xiii}, 1889, p. 306 s.}, já apon­tei que o
...
fim, a observação de Stedmann\footnote{Stedman, \emph{Voyage à Surinam}.
  Paris an \textsc{vii} de la Rep., v.\,\textsc{iii}, p. 414.} sobre os ín­dios do
...
concepção\footnote[*]{No original em alemão, o termo usado por Max
  ...
  {[}Nota do tradutor{]}} dos Paresí"-Kabizi, a natureza toda é povoada por bons e maus
...
Negro\footnote{Koch"-Grünberg, \emph{Zwei Jahre unter den Indianern}, l.
  c., v.\,\textsc{i}, p. 161.} e nas cabe­ceiras do Xingu\footnote{K. von den
...
português\footnote[*]{\emph{Brasilianische Sprache} no original, \emph{língua
  brasileira} {[}Nota do tradutor{]}.}. Nesse caso, sua escrita consistia em rabiscos sem conteúdo,
...
ou outra tribo tivesse planejado algum ataque contra eles\footnote{Gumilla,
  l. c., Tomo I, p, 154.}. Os Aruaque sempre
...
ali, a seringuei­ros\footnote[*]{Em português no original {[}Nota do tradutor{]}.} e membros da Comissão Telegráfica {[} Rondon{]}.
...
representa as cul­turas Aruaque, sendo que \textsc{i-iii} coincidem. Do círculo
...
contabilizadas entre as formas de casas dos círcu­los culturais \textsc{iv} e \textsc{v}
...
enterro, cor­respondente aos círculos \textsc{i-iii}.
...
lá fora contra a sua pró­pria vontade {[}\ldots{}{]}. A seguir, o relato
...
agora, também na mitologia''.\footnote{Koch"-Krünberg a Walter Lehmann,
  07/12/1919, \textsc{vk} Mr. A. 29.} Mas Koch"-Grünberg não conse­guiu mais
...
primiti­vos''.\footnote{Schmidt (1917, p. 70ss). Nesta edição, p. \textsc{xxx}.
...
\textsc{vk} Mr Nachlass Theodor Koch"-Grünberg. Völkerkund­liche Sammlung der
...
ethnologi­schen Grundlagen} (Mythologische Bibliothek, \textsc{iv} Band, Heft
...
etno­lógicas sobre el arte indígena a principios del siglo \textsc{xx}. In: \textsc{baer},
...
\textsc{koch"-grünberg}, Theodor. \textit{Die Xingu"-Expedi­tion (1898--1900): Ein
...
\chapter[Max Schmidt -- seus últimos dias, \emph{por Paulo de Carvalho Neto}]{Max Schmidt -- seus últimos dias\footnote{Texto originalmente
  ...
  Paraguay (\textsc{ceap}), Doc. 10, 14/03/1951. Tradução: Peter Schröder.}}
...
comida, ele mesmo la­vava os pratos\ldots{} Já se esgotavam suas últimas
