...
vemos, por fim, ao lado das tribos aruaquess e Karib, o aparecimento das
...
Aruaque, já se depreende das condições análogas às dos Aruaques nas
...
irromperam em períodos posteriores no território dos Aruaques. Aqui
...
Aruaque individuais. De acordo com o Padre Schmidt, os Aruaques, ao lado
...
arco melanésio'' --- é indicada apenas em três tribos aruaquess: os
...
fase de transição. No que concerne os tipos de casas das tribos aruaquess
...
de dormir, que é referida com uma grande quantia de tribos aruaquess. No
