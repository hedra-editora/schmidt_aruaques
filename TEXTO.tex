...
típicas na clareira da mata. Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,202 s.}
...
cabeceiras do Jueruena e do Guaporé, se planta mais milho.\footnote{Max
  Schmidt, \textit{Die Paressí"-Kabisí}, p.\,204 s.} Os Chané, que
...
não estrague.\footnote{Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,206
 \textsc{ss}.}
...
finos\footnote{Koch"-Grünberg, \textit{Zwei Jahre unter den Indianern}, v.\,\textsc{ii}, p.\,218\textsc{ss}. Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,209 s.} ou
...
qual os Aruaques se apresentam como classe senhorial\footnote{\textit{Herrenklasse}} e à qual se impõe a execução dos trabalhos
...
Aweti.\footnote{\textls[-25]{Do mesmo autor, \textit{Unter den Naturvölkern
...
Os Araycu ou Uraycu, pertencentes aos Aruaques, que já moravam há muito
...
circunstâncias.\footnote{Cf. Max Schmidt, \textit{Die Paressí"-Kabisí}, l.c. As
...
formação foram desenvolvidas.\footnote{Kunike fornece uma boa e clara
  ...
  cit., p.\,32ss.} O significado econômico da couvade, do qual, a
...
cultura aruaque.\footnote{Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,237 s.}
...
respectiva família, que tem seu local de repouso próximo delas.\footnote{Max
  Schmidt, \textit{Die Paressí"-Kabisí}, p.\,195 s.} Atribui"-se forças
...
lugar,\footnote{Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,230 s.} e a leitura em uma interpretação arbitrária desses
...
começos das artes plásticas entre esses índios,\footnote{Max Schmidt,
  \textit{Die Paressí"-Kabisí}, p.\,231 s.} uma vez que justamente nos últimos
...
especificamente a seguir,\footnote{} do mesmo Manuel e do Paresí Josévieira de
...
posição de poder político não se encontra em suas mãos.\footnote{Assim
  ...
  Chaco bis zum Ausgange des 18. Jahrhunderts'', p.\,69 s.} Em
...
forma, Antonio Pires de Campos comenta no ano de 1723,\footnote{\textit{Revista
  ...
  \textsc{k}.\,von den Steinen, \textit{Unter den Naturvölkern}, p.\,424 s.} dos
...
culturas diferentes, frisa com grande sagacidade\footnote{Erland Nordenskiöld, ``Archäologische Forschungen im bolivianischen
  ...
  Flachlande'', p.\,250 s.} que, no leste da Bolívia, a cultura
...
para a expansão das s, assim também os círculos e
...
franco\footnote{\textit{Freimutterrechtlicher Kulturkreis}} ou da assim
chamada cultura do arco\footnote{\textit{Bogenkultur}} para a América do Sul
...
tribos aruaques: o machado com \textit{knee"-shaft}\footnote{\textit{Kniestiel}}
...
forma primitiva de obter fogo por friccionar duas madeiras ---\footnote{\textit{Feuerbohren}}
...
estreitamente com os meios empregados pelos Aruaques para a expansão das
...
\item
  Por isso a questão pela origem das culturas aruaques não pode ser
  equiparada com a questão pela origem das tribos aruaques.
\item
...
\item
  ...
  que as culturas aruaques, ao criar sua posição de domínio, se
...
influência das culturas aruaques, e se esses princípios realmente se
...
de pesquisadores que influenciariam a jovem disciplina ``etnologia''\footnote{No original: \textit{Völkerkunde}}
...
sua noção de pensamentos elementares\footnote{Elementargedanken} universais, 
que continuavam se desenvolvendo, no interior de uma ``província geográfica'', 
para unidades culturais específicas, os pensamentos dos povos,\footnote{Völkergedanken} 
...
teses de Graebner, Foy, Ankermann e \textsc{p}.\,\textsc{w}. Schmidt.\footnote{Sobre a
  ...
  591\textsc{ss}), apesar das informações inexatas sobre Paul Ehrenreich e Max
...
23, 92--96, 104. (p.\,20ss, 44, 120--124, 133 nesta edição)} Em
...
detalhada de questões sociológicas e econômicas.\footnote{Além disso,
  ...
  sem dúvida, por Curt Unckel Nimuendaju. Nimuendaju
...
entre etnologia e estudos sociais,\footnote{\textit{Gesellschaftslehre}}
...
pessoal e guerra, organização política e classes sociais,\footnote{\textit{Klassenwesen}} parentelas e associações masculinas,\footnote{\textit{Sippen- und Männerbundsgemeinschaft}} comunhão e troca na
alimentação, propriedade e inalienabilidade de terra'',\footnote{\textit{Bodensperre}} mas também ``o surgimento e a essência do
...
Com sua hipótese de superimposição social,\footnote{\textit{Überschichtungshypothese}. Münzel (2004, p.\,438).}
