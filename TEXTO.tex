...
Berücksichtigung der Naturvölker'' in: \emph{Archiv für Anthropologie}, nova série,
...
esclarecer o sentido do nome \emph{Aruaque} levado em consideração aqui.
...
América do Sul.\footnote{Karl von den Steinen, \emph{Durch
  ...
  Ehrenreich, ``Die Einteilung und Verbreitung der Völkerstämme
  Brasiliens'', l. c. {[}\emph{loco citato}{]}, p. 15.} Este autor pressupusera a afinidade de diferentes tribos que hoje
...
reencontrado na região dos antigos Mojo.\footnote{Erland Nordenskiöld,
  ...
  ss.}\footnote{Ainda retornarei posteriormente, na discussão sobre as minhas
...
de Campos.{\emph{Revista Trimensal do Instituto Histórico}, \textsc{xxv},
