...
\textls[-10]{Justamente no presente trabalho sobre a expansão das culturas aruaques na
...
disputa por questões metodológicas. Através de Gräbner\footnote{Gräbner,
  ...
  cultura melanésia do arco e os seus afins{]}, em: \textit{Anthropos}, v.\,\textsc{iv}, fascículos 3, 4, 5, 6, 1909. Do mesmo, \textit{Methode der
...
principalmente através de \textsc{p}.\,\textsc{w}. Schmidt,\footnote{\textsc{p}.\,\textsc{w}. Schmidt,
  ``Kulturkreise und Kulturschichten in Südamerika``, em:
  \textit{Zeitschrift für Ethnologie,} ano 45, fascículo \textsc{vi}, 1913, p.\,1014\textsc{ss} {[}Edição brasileira: \textit{Ethnologia sul"-americana: circulos
...
apreciação de Arthur Haberland.\footnote{\textls[-10]{Arthur Haberland,
  ...
  de doutorado da Universidade \textsc{k. k.} de Viena. Braunschweig, 1912. Cf.
...
publicações dos resultados de suas viagens.\footnote{Koch"-Grünberg,
  ...
  enriquecimento dos nossos conhecimentos sobre as culturas aruaques. Cf.
  ...
  fascículo \textsc{iii}, 1913, p.\,448\textsc{ss},tal como em: \textit{Korrespondenzblatt
...
bom retrato do nível cultural dos antigos Mojo e Bauré,\footnote{Do mesmo
  ...
  {[}Urnas funerárias e morros na planície boliviana{]}, em:
...
viagem,\footnote{Max Schmidt, \textit``Die Paressí"-Kabisí. Ethnologische
  ...
  do Jauru e do Juruena{]}, em: \textit{Baessler"-Archiv}, Leipzig e
...
trabalho, limitado pelo formato.\footnote{Max Schmidt, \textsc{Die
...
América do Sul.\footnote{Karl von den Steinen, \textit{Durch
  ...
  Ehrenreich, ``Die Einteilung und Verbreitung der Völkerstämme
  Brasiliens''{[}\textit{loco citato}{]}, p.\,15.} Este autor pressupusera a afinidade de diferentes tribos que hoje
...
aceita pela etnologia moderna;\footnote{Cf., por exemplo, Ehrenreich,
  ``Die Einteilung und Verbreitung der Völkerstämme Brasiliens'', p.\,15. Kersten, Dr.\,Ludwig, ``Die Indianerstämme des Gran Chaco
...
eliminou"-se novamente o termo \textit{Nu} desta designação,\footnote{De acordo
  ...
  adjacentes{]}, Max Schmidt, \textit{Die Paressí"-Kabisí}.} e se
...
Japurá deve ser usado o mapa dos povos\footnote{Koch"-Grünberg, depois da
  ...
  para com as tribos aruaques{]}.} de Koch"-Grünberg.\footnote{Cf. o mapa
...
considerados uma tribo aruaque.\footnote{Erland Nordenskiöld,
  ...
  156\textsc{ss}.} Por fim, os Parecis formam o elo de ligação com as
...
p.\,216\textsc{ss},238.} e estas se diferenciam fundamentalmente das
...
esses últimos.\footnote{Max Schmidt, \textit{Indianerstudien in
  Zentralbrasilien}, p.\,345\textsc{ss}.} Nas cabeceiras do Xingu são
...
remo.\footnote{Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,245. Karl
  von den Steinen foi infomado pelos Parecis da região de Diamantino a
...
tempo, que os Aruaques exibiram ali.\footnote{Cf. Martius, \textit{Beiträge
  zur Ethnographie und Sprachkunde Amerikas, zumal Brasiliens}, v.\,\textsc{i}, p.
  578.} O grau relativamente elevado das culturas aruaques nas Grandes
...
reencontrado na região dos antigos Mojo.\footnote{Erland Nordenskiöld,
  ``Urnengräber und Mounds im bolivianischem Flachlande'', p.\,244
...
Jamamadi e Paumari, visitados por Ehrenreich.\footnote{Cf. Ehrenreich,
  \textit{Die Ethnographie Südamerikas im Beginn des \textsc{xx}. Jahrhunderts}, p.
  49.}
...
Mojos\footnote{Erland Nordenskiöld, ``Urnengräber und Mounds im
  bolivianischen Flachland'', p.\,811\textsc{ss}.} permitem supor que os
...
finos\footnote{Koch"-Grünberg, \textit{Zwei Jahre unter den Indianern}, v.\,\textsc{ii}, p.\,218\textsc{ss}. Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,209s.} ou
...
grandes com relação ao número de moradores.\footnote{Em \textit{Die Paressí"-Kabisí}, p.\,191\textsc{ss}., discuti
...
suficiente sobre a construção das casas entre as tribos
aruaques, para reconhecer aqui a grande façanha de trabalho desempenhada
com meios proporcionalmente tão limitados, como em Everhard F. im Thurn, \textit{Among the Indians of
  ...
  den Indianern}, v.\,\textsc{i}, p.\,69\textsc{ss}. Max Schmidt, \textit{Die Paressí"-Kabisí}, p.\,191\textsc{ss}.}} Nos arredores da casa também
...
através das escavações de Erland Nordenskiöld,\footnote{Erland
  Nordenskiöld, p.\,223, 238, 240.} precisavam ser obtidos de
...
qual os Aruaques se apresentam como classe senhorial\footnote{Em alemão, \textit{Herrenklasse}.} e à qual se impõe a execução dos trabalhos
...
mútuo,\footnote{Op.\,Cit. Cf. Everhard F. im Thurn, \textit{Among the
...
Awetis.\footnote{\textls[-25]{Do mesmo autor, \textit{Unter den Naturvölkern
  Zentral"-Brasiliens}, p.\,101, 109, 121\textsc{ss},154.}} Aqui é notável que
...
frequentemente das cerimônias funerárias.\footnote{Koch"-Grünberg,
  \textit{Zwei Jahre unter den Indianern}, v.\,\textsc{i}, p.\,169\textsc{ss}; v.\,\textsc{ii}, p.\,138\textsc{ss}.}}
...
circunstâncias.\footnote{Cf. Max Schmidt, \textit{Die Paressí"-Kabisí}, As
...
direito materno. Neste sentido, a narração de Koch"-Grünberg\footnote{Koch"-Grünberg,
  \textit{Zwei Jahre unter den Indianern},v.\,\textsc{i}, p.\,180\textsc{ss}.}
...
matrimônio por compra\footnote{\textit{Kaufehe}.} entre índios
...
formação foram desenvolvidas.\footnote{Kunike fornece uma boa e clara
  ...
  cit., p.\,32\textsc{ss}.} O significado econômico da couvade, do qual, a
...
interessante, que \textsc{k}.\,von den Steinen fornece dos Bakairi.\footnote{\textsc{k}.\,von 
den Steinen, \textit{Unter den Naturvölkern Zentral"-Brasiliens}, p.
...
incorreta, portanto, a suposição de Dargun sobre a couvade,\footnote{Dargun,
...
Makázore, foi atribuída à mesma causa.\footnote{Op.\,Cit., p.
...
\textls[-31]{O bom médico ou feiticeiro, o \textit{otuhariti}, é o único capaz de agir
...
outras regiões das culturas aruaques.\footnote{Koch"-Grünberg, \textit{Zwei
  Jahre unter den Indianern}, v.\,\textsc{ii}, p.\,162 e 173\textsc{ss},252. \textsc{k}.\,von den
...
nos vasos provenientes dos morros da planície de Mojos,\footnote{Nordenskiöld,
  ``Urnengräber und Mounds im bolivianischem Flachlande'', p.\,217\textsc{ss}.} 
...
chamada cultura do arco\footnote{Em alemão, \textit{Bogenkultur}.} para a América do Sul
...
tribos aruaques: o machado com \textit{knee"-shaft}\footnote{Em alemão, \textit{Kniestiel}.}
...
forma primitiva de obter fogo por friccionar duas madeiras ---\footnote{Em alemão, \textit{Feuerbohren}.}
...
dos antigos Mojo, existiam machados de pedra polida,\footnote{Erland
  Nordenskiöld, \textit{Urnengräber und Mounds im bolivianischen Flachlande}, p.\,223\textsc{ss}.} 
...
Com essas palavras termina o obituário que Herbert Baldus
publicou em 1951 em homenagem ao etnólogo Max Schmidt, que
...
que influenciariam a jovem disciplina \textit{etnologia}\footnote{Em alemão: \textit{Völkerkunde}.}
...
(Schmidt, 1905, p.\,24, 40\textsc{ss}). Além disso, Schmidt percebeu alterações
...
pesquisadores futuros que as verificassem''.\footnote{Krause (1911a:
  111\textsc{ss}, meu destaque). Que essas passagens introdutórias de fato fossem
...
esse tempo.\footnote{Os planos referentes aos anos 1910, 1914 e 1916
  encontram"-se em \textsc{vk} Mr G.I.1. Cf. também Kraus (2004a, p.\,106\textsc{ss},
  264\textsc{ss}).} Sobretudo a eclosão da Primeira Guerra Mundial, com a qual
...
financeiro do \textit{Comitê de auxílio etnológico},\footnote{O \textit{Ethnologisches Hilfkomitee}, que existiu
...
mágicas.\footnote{Koch"-Grünberg a \textsc{a}\,\textsc{v}. Frič, 13/04/1916, StA Lu (\textsc{el}
...
sua noção de pensamentos elementares\footnote{Em alemão, \textit{Elementargedanken}.} universais, 
que continuavam se desenvolvendo, no interior de uma ``província geográfica'', 
para unidades culturais específicas, os pensamentos dos povos,\footnote{Em alemão, \textit{Völkergedanken}} 
...
(Graebner, 1911, p.\,108; cf. também Ankermann, 1911, p.\,159\textsc{ss}).
...
tentavam contextualizar a \textsc{etnologia} unicamente como parte das
...
teses de Graebner, Foy, Ankermann e \textsc{p}.\,\textsc{w}. Schmidt.\footnote{Sobre a
  ...
  sul"-americanistas alemães, veja em detalhes Kraus (2004a, p.\,469--481). Para uma crítica geral, em que nos \textsc{eua} posteriormente também
  se posicionaram Franz Boas e Robert Lowie, cf. Petermann (2004, p.\,591\textsc{ss}), apesar das informações inexatas sobre Paul Ehrenreich e Max
...
encaixam'' (Preuss, 1927, p.\,146\textsc{ss}). O que os americanistas censuraram
...
23, 92--96, 104. (p.\,20\textsc{ss}, 44, 120--124, 133 nesta edição)} Em
...
surgimento e desenvolvimento autônomos''.\footnote{Schmidt (1918, p.\,13\textsc{ss}). Aqui Schmidt refere"-se a Graebner (1911, p.\,94). Cf. também
...
disso, o estudo da chamada \textit{cultura espiritual},\footnote{Em alemão, \textit{geistige
...
entre etnologia e estudos sociais,\footnote{Em alemão, \textit{Gesellschaftslehre}.}
...
pessoal e guerra, organização política e classes sociais,\footnote{Em alemão, \textit{Klassenwesen}.} parentelas e associações masculinas,\footnote{Em alemão, \textit{Sippen- und Männerbundsgemeinschaft}.} comunhão e troca na
alimentação, propriedade e inalienabilidade de terra'',\footnote{Em alemão, \textit{Bodensperre}.} mas também ``o surgimento e a essência do
...
Steinen, que na época apresentou uma teoria sobre a \textit{proto"-pátria}\footnote{Em alemão, \textit{Urheimat}.} dos Karib, posteriormente refutada, acentuou o
...
povo.\footnote{Schmidt (1917, p.\,8\textsc{ss}, 15\textsc{ss}, 19\textsc{ss}, 72). Nesta edição: p.
  27\textsc{ss}, 34\textsc{ss}, 39\textsc{ss}, 99.} Ao invés disso, ele frisa, que 
...
Com sua hipótese de superimposição social,\footnote{Em alemão, \textit{Überschichtungshypothese.}. Münzel (2004, p.\,438).}
...
%   em \textit{Revista do Museu Paulista}, Nova Série, São Paulo, v.\,V, p.
